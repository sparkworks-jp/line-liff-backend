...
class Order(models.Model):
    ...
    payment_qr_code_id= models.CharField(null=True, blank=True,max_length=256,db_comment='支払い検証クラスID')
    payment_id = models.CharField(max_length=256,null=True, blank=True, db_comment='支払い番号:paypay　支払い番号')
    created_at = models.DateTimeField(null=True, blank=True,auto_now_add=True, db_comment='作成日時')
    updated_at = models.DateTimeField(null=True, blank=True,auto_now=True, db_comment='更新日時')
    updated_by = models.CharField(max_length=256, null=True, blank=True, db_comment='更新者')
    created_by = models.CharField(max_length=256, null=True, blank=True, db_comment='登録者')
    deleted_flag = models.BooleanField(null=True, blank=True, db_comment='削除フラグ')
